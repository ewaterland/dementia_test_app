package com.example.dementia_test;
...
import com.example.dementia_test.Center.CenterActivity;
import com.example.dementia_test.Chatbot.ChatbotMainActivity;
import com.example.dementia_test.Community.CommunityMainActivity;
import com.example.dementia_test.Hospital.HospitalListActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Adapter
        pagerAdapter = new com.example.dementia_test.Ad.AdAdapter(this, num_page);
        ...
        btn_dementiaTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, com.example.dementia_test.TestCogDep.TestMainActivity.class); // 다른 화면으로 이동
        ...
        btn_memoryTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplication(), com.example.dementia_test.TestMemory.Memory01Activity.class);
                startActivity(intent);
                docRef.update("ResultHide", hide);
            }
        });
