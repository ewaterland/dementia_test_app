package com.example.dementia_test.TestCogDep;
...
import com.example.dementia_test.Z_etc.ProgressModel;
...
public class TestDepActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    // 검사 페이지 진행바
    public com.example.dementia_test.Z_etc.ProgressModel progressModel;
