...
public class CogTestActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cog_test);

        Log.w(TAG, "--- CogTestActivity ---");
    ...
    private class QuestionChangeTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Log.w(TAG, "# question: " + currentPage + " / 현재 질문: Q" + now);

            // 질문 불러오기
            try {
                question_db.getReference("Cog").child(path).addValueEventListener(new ValueEventListener() {
                    @Override
    ...
    public void loadNextQuestion() {
        ...
        else
        {
            ...
            // 결과 페이지로 점수 전송
            Intent intent_result = new Intent(getApplication(), MemoryResultActivity.class);
