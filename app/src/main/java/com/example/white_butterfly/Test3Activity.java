...
public class Test3Activity extends AppCompatActivity implements CurrentPageListener {
    ...
    public void onPageUpdated(int currentPage) {
        ...
        Log.w(TAG, "Test3Activity currentPage: " + currentPage);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Firebase
        FirebaseApp.initializeApp(Test3Activity.this);
        ...
        progressModel = new ViewModelProvider(Test3Activity.this).get(ProgressModel.class);
    ...
    private void answer_18()
    {
        ...
        // 나머지 답변1 불러오기
        do {
            value1 = String.valueOf(random.nextInt(8) + 1);  // 1~8 사이의 랜덤값
        ...
        // 나머지 답변2 불러오기
        do {
            value2 = String.valueOf(random.nextInt(8) + 1);  // 1~8 사이의 랜덤값
    ...
    private void loadNextQuestion() {
        ...
        if (currentPage <= 23) {
            ...
            Log.w(TAG, "Test3Activity 현재 페이지: " + currentPage);

            currentQuestion = currentPage + 1;
            db_q();

            text_q_num.setText(String.valueOf(currentPage + 1));
            progressModel.getProgressLiveData().observe(Test3Activity.this, progress -> {
                progressBar.setProgress(currentPage);
                Log.w(TAG, "Test3Activity 프로그레스: " + currentPage);
            });
