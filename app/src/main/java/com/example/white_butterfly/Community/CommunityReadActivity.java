...
public class CommunityReadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // firebase 접근 권한 갖기
        FirebaseApp.initializeApp(CommunityReadActivity.this);
                ...
                newNodeReference.setValue(nodecontent)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(CommunityReadActivity.this, "저장 성공", Toast.LENGTH_SHORT).show();
                                Log.d(TAG, "< 저장 성공 >");
                            }
                        })
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(CommunityReadActivity.this, "저장 실패", Toast.LENGTH_SHORT).show();
